...
{
    VariableDefinePlatformVar(hc, NULL, "M_E", &hc->FPType, (union AnyValue *)&M_EValue, FALSE);
    VariableDefinePlatformVar(hc, NULL, "M_LOG2E", &hc->FPType, (union AnyValue *)&M_LOG2EValue, FALSE);
    VariableDefinePlatformVar(hc, NULL, "M_LOG10E", &hc->FPType, (union AnyValue *)&M_LOG10EValue, FALSE);
    VariableDefinePlatformVar(hc, NULL, "M_LN2", &hc->FPType, (union AnyValue *)&M_LN2Value, FALSE);
    VariableDefinePlatformVar(hc, NULL, "M_LN10", &hc->FPType, (union AnyValue *)&M_LN10Value, FALSE);
    VariableDefinePlatformVar(hc, NULL, "M_PI", &hc->FPType, (union AnyValue *)&M_PIValue, FALSE);
    VariableDefinePlatformVar(hc, NULL, "M_PI_2", &hc->FPType, (union AnyValue *)&M_PI_2Value, FALSE);
    VariableDefinePlatformVar(hc, NULL, "M_PI_4", &hc->FPType, (union AnyValue *)&M_PI_4Value, FALSE);
    VariableDefinePlatformVar(hc, NULL, "M_1_PI", &hc->FPType, (union AnyValue *)&M_1_PIValue, FALSE);
    VariableDefinePlatformVar(hc, NULL, "M_2_PI", &hc->FPType, (union AnyValue *)&M_2_PIValue, FALSE);
    VariableDefinePlatformVar(hc, NULL, "M_2_SQRTPI", &hc->FPType, (union AnyValue *)&M_2_SQRTPIValue, FALSE);
    VariableDefinePlatformVar(hc, NULL, "M_SQRT2", &hc->FPType, (union AnyValue *)&M_SQRT2Value, FALSE);
    VariableDefinePlatformVar(hc, NULL, "M_SQRT1_2", &hc->FPType, (union AnyValue *)&M_SQRT1_2Value, FALSE);
}
